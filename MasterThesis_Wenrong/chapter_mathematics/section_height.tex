...
% \begin{remark}
%     In Lurie's lecture notes \cite{lurielecture12}, there is a slight modification
%     of the definition of the height of a formal group law. We say $F(X,Y)$ has height $\ge n$
%     if $v_i = 0$ for all $i < n$.
%     We say $F(X,Y)$ has height exactly $n$ if $v_n$ is invertible in $R$.
% \end{remark}
...
% \begin{proof}
%     A proof can be found in Lurie's lecture notes \cite{lurielecture13} and \cite{lurielecture14}.
% \end{proof}

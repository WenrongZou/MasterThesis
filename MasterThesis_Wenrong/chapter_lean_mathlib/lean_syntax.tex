...
Lean operates as both an interactive theorem prover and a functional programming language.
In Lean, definitions, statements, and proofs are written in a syntax that is
subsequently verified by the Lean kernel. In this section, we introduce several
foundational pieces of Lean syntax that will appear frequently in later chapters.
